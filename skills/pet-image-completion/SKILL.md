...
- 模型：Replicate 上使用 `stability-ai/stable-diffusion-inpainting`（或当前推荐的 inpainting 模型，见 [reference.md](reference.md)）。
...
- Inpainting 模型列表与 API schema 见 [reference.md](reference.md)。
